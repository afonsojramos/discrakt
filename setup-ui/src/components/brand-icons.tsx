...
// Brand marks from Simple Icons (https://simpleicons.org), rendered in
// currentColor so they inherit the surrounding text color.

export function TraktIcon(props: SVGProps<SVGSVGElement>) {
  return (
...
export function PlexIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 512 512" fill="currentColor" aria-hidden focusable={false} {...props}>
      <path d="M256 70H148l108 186-108 186h108l108-186z" />
    </svg>
  );
}
